...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', choices=['train', 'translate', 'retrain', 'extract'], default='train')
    ...
    parser.add_argument('--model-file', type=str,
                        help='Path to saved checkpoint if mode == translate or retrain')
    parser.add_argument('--epochs', type=int, default=0,
                        help='Number of epoch left to run for pretrain')                    
    ...
    if args.mode == 'train':
        ...
        trainer = Trainer(args)
        trainer.retrain(args.epochs,args.model_file)
